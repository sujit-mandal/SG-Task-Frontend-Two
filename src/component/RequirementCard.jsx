  ...
  return (
    <>
      ...
      <div className="max-w-screen-xl mx-auto grid grid-cols-2 gap-x-6 gap-y-8 pt-24 pb-36">
        <div className="relative bg-[#59C3CF] rounded-[32px] transform transition-all duration-300 ease-in-out group hover:h-[750px]">
        ...
        <div className="relative bg-[#E2635E] rounded-[32px] transform transition-all duration-300 ease-in-out group hover:h-[750px]">
          <div className="h-[450px]">
            <div className="text-white px-8 py-14">
        ...
        <div className="relative bg-[#A881F3] rounded-[32px] transform transition-all duration-300 ease-in-out group hover:h-[750px]">
          <div className="h-[450px]">
            <div className="text-white px-8 py-14">
        ...
        <div className="relative bg-[#58B1EA] rounded-[32px] transform transition-all duration-300 ease-in-out group hover:h-[750px]">
          <div className="h-[450px]">
            <div className="text-white px-8 py-14">
